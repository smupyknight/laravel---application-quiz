...
<div class='row item section'>
	<div class='row title'>
		<div class='col-md-6 col-md-offset-3'>
			<h1>7. What is your employers address?*</h1>
		</div>
	</div>
	<div class='content'>
		<div>
			<input type='text' placeholder='Address' class='required' name='app_emplyer_address'/>
		</div><br>
		<div>
			<input type='text' placeholder='City' class='required' name='app_employer_city'/>
		</div><br>
		<div class="dropdown-wrapper">
			<a class="dropdown-toggle" id="state-dropdown-button" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"> 
				<span class='selected-option required' name='app_employer_state' data-selected='false'>Select state</span><span class='glyphicon glyphicon-triangle-bottom'></span>
			</a> 
		...
		<div>
		<input type='text' placeholder='Zipcode' class='required' name='app_employer_zipcode'/>
		</div><br>
	</div>
